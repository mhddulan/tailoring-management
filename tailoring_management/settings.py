...
SECRET_KEY = 'django-insecure-pz&qat11-^de(cflg%+$(q9pmk^4tl_mu4yf15ipla1b=9d@kh'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "tailoring"),
        "USER": os.environ.get("DB_USER", "tailoring_user"),
